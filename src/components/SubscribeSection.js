...
const SubscribeSection = () => {
  return (
    <div className="bg-primary text-white rounded-t-3xl rounded-b-3xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-center w-[95%] max-w-6xl mx-auto mb-[-5%] z-20 relative space-y-6 md:space-y-0">
      {/* Left Content */}
